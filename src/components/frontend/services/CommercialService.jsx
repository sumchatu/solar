...
const CommercialService = () => {
  return (
    <>
        ...
        <main>
            {/* Hero Section Starts*/}
                <Hero heroClass='section-services' preHeading='Our Services' heading='Commercial Solar Solutions' text='We excel at transforming visions into reality <br/>
                    ...
                    <div className='container py-3'>
                        <div className='row'>
                            <div className='col-md-12'>
                                ...
                                <p>
                                Upgrade your business with TD Solar’s Commercial Solar Solutions. We provide customized solar PV systems for businesses, institutions, and industries, helping you cut energy costs and promote sustainability.
                                </p>
                            </div>
                            <div className='col-md-12'>
                                <center><h2>What We Offer?</h2></center>
                                <p>
                                    <b>Tailored Solar Systems:</b> We design solar solutions that match your business’s energy requirements.<br />
                                    <b>Cost Savings:</b> Reduce your electricity bills and improve your bottom line. <br />
                                    <b>Sustainable Brand Image:</b>Showcase your commitment to renewable energy and environmental responsibility.<br />
                                    <b>End-to-End Services:</b> From consultation and design to installation and maintenance, we handle it all.
                                </p>
                            </div>
                            <div className='col-md-12'>
                                ...
                                <p align='center'>
                                    <ul>
                                        <li>
                                          Proven track record in commercial solar projects.
                                        </li>
                                        <li>
                                          Skilled team with extensive experience in large-scale installations.
                                        </li>
                                        <li>
                                          Focus on delivering maximum ROI for your business.
                                        </li>
                                    </ul>
                                </p>
                            </div>
