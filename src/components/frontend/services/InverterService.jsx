...
const InverterService = () => {
  return (
    <>
        ...
        <main>
            {/* Hero Section Starts*/}
                <Hero heroClass='section-services' preHeading='Our Services' heading='Solar Inverters and Controllers Servicing' text='We excel at transforming visions into reality <br/>
                    ...
                    <div className='container py-3'>
                        <div className='row'>
                            <div className='col-md-12'>
                                <span>Solar Inverters and Controllers Servicing</span>
                                <p>
                                Your solar inverter and controllers are critical components of your solar PV system. At TD Solar, we provide specialized Servicing for Solar Inverters and Controllers to ensure they function efficiently.
                                </p>
                            </div>
                            <div className='col-md-12'>
                                <center><h2>What We Offer?</h2></center>
                                <p>
                                    <b>Diagnostic Services:</b> We identify and resolve issues with your inverters and controllers.<br />
                                    <b>Repair and Replacement:</b> Our team repairs or replaces faulty components to restore system performance.<br />
                                    <b>Preventive Maintenance:</b>Regular servicing to prevent breakdowns and extend the lifespan of your equipment.<br />
                                    <b>Expert Advice:</b> We provide guidance on maintaining your inverters and controllers for optimal performance.
                                </p>
                            </div>
                            <div className='col-md-12'>
                                ...
                                <p align='center'>
                                    <ul>
                                        <li>
                                          Skilled technicians with in-depth knowledge of solar inverters and controllers.
                                        </li>
                                        <li>
                                          Use of genuine parts and components for repairs.
                                        </li>
                                        <li>
                                          Commitment to ensuring your system operates smoothly.
                                        </li>
                                    </ul>
                                </p>
                            </div>
